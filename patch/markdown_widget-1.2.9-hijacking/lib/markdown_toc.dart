// ignore_for_file: depend_on_referenced_packages, library_private_types_in_public_api, prefer_generic_function_type_aliases
...
class TocController extends ChangeNotifier {
  ...
  bool setToc(Toc toc) {
    if (_currentToc == toc) return false;
    _currentToc = toc;
    return true;
  }
  ...
  bool setTocList(LinkedHashMap<int, Toc>? tocList) {
    if (_tocList == tocList) return false;
    _tocList = tocList;
